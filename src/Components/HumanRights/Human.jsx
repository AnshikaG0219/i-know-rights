    ...
    <>
      ...
      <Grid container spacing={2} className={classes.uphold}>
        <Grid md={7} sm={12} className={classes.slides}>
          ...
          <div
            style={{ color: "white", margin: "2rem 3rem", fontSize: "1.1rem" }}
          >
            Human rights are basic rights that belong to all of us simply
            because we are human. They embody key values in our society such as
            fairness, dignity, equality and respect. ... Most importantly, these
            rights give us power and enable us to speak up and to challenge poor
            treatment from a public authorit
          </div>
        </Grid>
      ...
      <div style={{ backgroundColor: "#e3fdfd" }}>
        <Grid container className={classes.cards}>
          {cardDetails.map((card) => (
            <Grid card key={card.id} lg={4} md={6} sm={12} className={classes.card}>
